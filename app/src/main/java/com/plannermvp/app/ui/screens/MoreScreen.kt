...
/**
 * Release 1.0:
 *  - Added onCalendarClick (Calendar was listed but not wired)
 *  - Added onBackupClick  (Backup was accessible only through Settings)
 *  - More is a stateless hub — it never holds child navigation state
 */
@Composable
fun MoreScreen(
    onMatrixClick:   () -> Unit = {},
    ...
    val entries = listOf(
        ...
        MoreEntry(R.string.more_calendar, onCalendarClick),
        MoreEntry(R.string.more_import,   onImportClick),
        MoreEntry(R.string.more_settings, onSettingsClick),
        MoreEntry(R.string.more_backup,   onBackupClick)
    )
