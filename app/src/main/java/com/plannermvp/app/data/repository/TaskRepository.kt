...
class TaskRepository(private val taskDao: TaskDao) {
    ...
    /**
     * Release 1.0: Called when a project is deleted.
     * Tasks belonging to the project are KEPT — only the project link is removed.
     */
    suspend fun clearProjectAssociation(projectId: String) =
        taskDao.clearProjectAssociation(projectId)
}
